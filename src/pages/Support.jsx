...
export default function Support() {
  usePageMeta('Support Us — Ad-Free & Independent | Socion™', 'Socion is ad-free and built by one person. Tip on Ko-fi or keep using it free — every bit of support helps.')
  return (
