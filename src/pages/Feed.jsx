                ...
                {displayed.map((p, i) => (
                  <>
                    ...
                    {i === 7 && !dismissedAds['get-typed'] && (
                      <FeedAd id="get-typed" eyebrow="Get typed" headline="Working hypothesis or final answer?" body="Most people spend years second-guessing their type. A written report from Spencer Stern analyses your cognitive functions, rules out lookalikes, and gives you a confident answer you can build on. Your verified badge updates automatically." ctaLabel="Book a session →" onClick={() => { window.umami?.track('feed-get-typed-clicked'); navigate('/typing') }} onDismiss={() => dismissAd('get-typed')} />
                    )}
